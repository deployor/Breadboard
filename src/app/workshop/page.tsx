    ...
    <DocsFrame>
      <section>
        ...
        <ProseCard>
          ...
          <blockquote>
            <p>
              This project is built <strong>in Tinkercad Circuits</strong>, not
          ...
          <ol>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  Now connect red to red and black to black. The red wire
                  carries voltage, and the black wire is ground.
                </li>
                ...
                <li>
                  ...
                  <strong>resistor</strong>. Connect them as such, then wire
                  them! Use different rows/columns than me, just to challenge
                  yourself.
                  <img
          ...
          <p>
            You&rsquo;re taking the <strong>positive output</strong> of your
            power supply and connecting it to the{" "}
            <strong>red power rail</strong> on the breadboard. This rail becomes
            the source of <strong>voltage</strong> for the entire circuit.
          </p>
          ...
          <p>
            ...
            breadboard. This rail becomes the <strong>return path</strong> for
            the circuit.
          </p>
          ...
          <p>
            Ground is the <strong>reference point</strong> for the entire
            circuit. Think of it as the <strong>zero level</strong> that
          ...
          <ul>
            ...
            <li>
              Without ground, the circuit has <strong>no return path</strong>,
              so nothing works.
            </li>
          </ul>
          <p>
          ...
          <ul>
            ...
            <li>
              Too <strong>high</strong> voltage &rarr; LED tries to pull too
              much current and burns out
            </li>
          </ul>
          <p>
            Voltage matters because every component is designed to operate
          ...
          <p>
            Current is the <strong>amount of electrical flow</strong> through
            the circuit.
          </p>
          <ul>
          ...
          <p>
            LEDs are <strong>current-sensitive</strong> devices. They
            don&rsquo;t care much about voltage; they care about{" "}
          ...
          <p>
            This is why you add a <strong>resistor;</strong> it limits current
            to a safe level.
          </p>
          ...
          <p>
            Real resistors only come in standard values. The way these values
            are chosen is really interesting! You should read about it{" "}
          ...
          <p>
            If the LED stays on or never turns on, that simply means a
            connection needs adjustment.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>The resistor protects the LED</strong> &mdash; It must be
              in series with the LED; it may be placed on either side
            </li>
            <li>
          ...
          <ul>
            <li>
              When the button is <strong>not pressed</strong>, the circuit is
              open and no current flows
            </li>
            <li>
              When the button <strong>is pressed</strong>, the circuit closes
              and current flows through the resistor and LED
            </li>
          ...
          <p>
            Use <strong>Start Simulation</strong> to observe changes as you
            adjust connections.
          </p>
