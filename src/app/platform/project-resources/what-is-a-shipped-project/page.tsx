    ...
    <DocsFrame>
      <section>
        ...
        <ProseCard>
          ...
          <p>
            When you first make something, usually it just lives as a file on
            your computer. This is bad because only YOU can access it! Nobody
            else can see it. Not only that, but when you look back at the
            project a few years from now it&apos;ll be very, <em>very</em>{" "}
          ...
          <ul>
            ...
            <li>
              <strong>
                Making all files &amp; resources easily accessible &amp;
                organized
              </strong>
            </li>
            <li>
              <strong>
                Putting it on a platform that&apos;s easily shareable (i.e
                GitHub, Printables, etc)
              </strong>
            </li>
          </ul>
            ...
            <ul className="space-y-3 text-sm text-black">
              <li className="flex items-start gap-3">
                ...
                <span>
                  ...
                  Screws, clips, or press fits. Something you&apos;d actually
                  hand to someone.
                </span>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>
                  ...
                  You built it, you proved it works. A video showing it doing
                  its thing is required.
                </span>
              </li>
            </ul>
          </div>
          ...
          <ul>
            <li>
              <a href="https://github.com/yiancar/Seigaiha">
                Seigaiha Keyboard
              </a>
            </li>
            <li>
          ...
          <ul>
            <li>
              <a href="https://github.com/adafruit/Adafruit-PiGRRL-PCB">
                PiGRRL
              </a>{" "}
              &mdash; Game console
            </li>
