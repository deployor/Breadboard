    ...
    <DocsFrame>
      <section>
        ...
        <ProseCard>
          ...
          <ul>
            <li>
              <strong>Breadboard Basics</strong> covers the fundamental
          ...
          <p>
            ...
            Don't just think about what you <em>need</em>, think about what
            would make it cooler.
          </p>
          <blockquote>
            <p>
              A tamagotchi only needs a screen, buzzer, and buttons. But
              wouldn't a motion detector be SO COOL so it wakes up when there's
              motion? Or a light sensor so it can sleep in the dark?
            </p>
          </blockquote>
          <p>
            Check out <a href="https://github.com/qcoral/">@alexren</a>'s{" "}
            <a href="http://hwdocs.hackclub.dev">hwdocs.hackclub.dev</a> for
            ...
            <div className="min-w-0 flex-1">
              ...
              <ul>
                <li>
                  ...
                  is open source and professional-grade. Works for everything
                  from beginner to complex multi-layer boards. Free.
                </li>
                <li>
          ...
          <p>
            Check the{" "}
            <a href="/platform/guides/example-submission">
              <strong>Example Submission</strong>
            </a>{" "}
            and{" "}
            <a href="/platform/project-resources/what-is-a-shipped-project">
