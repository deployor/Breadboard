    ...
    <DocsFrame>
      <section>
        ...
        <ProseCard>
          ...
          <p>
            Your kit has a clone board that works the same as the official Uno
            but uses a <strong>CH340 USB chip</strong>. You probably need to
            install the driver before your computer sees it.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Adafruit Learning System</strong> (beginner-friendly
              guides for basically every component):{" "}
          ...
          <p>
            Board manager URL to paste into{" "}
            <strong>File &gt; Preferences</strong>:
          </p>
          <pre>
            <code>
          ...
          <ul>
            ...
            <li>
              <strong>Last Minute Engineers</strong> (clear
          ...
          <h2>Libraries</h2>
          <p>
            Install any of these from{" "}
            <strong>Tools &gt; Manage Libraries</strong> in the IDE.
          </p>
          ...
          <p>
            Almost always a missing CH340 driver. Install it from the link
            above, unplug, replug.
          </p>
          ...
          <p>
            Run this I2C scanner sketch to find your device&rsquo;s address:
          </p>
          <ul>
            <li>
