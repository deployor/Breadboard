      ...
      <section>
        ...
        <ProseCard>
          ...
          <p>
            ...
            circuits to be assembled without soldering. It is the central
            platform on which most beginner circuits are built.
          </p>
          ...
          <ul>
            ...
            <li>
              The long side rails are connected vertically and are typically
              used for power (positive voltage and ground).
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            into the breadboard's power rails. It provides a stable voltage
            source for your circuits.
          </p>
          ...
          <h3>What They Are</h3>
          <p>
            Jumper wires are flexible conductors used to make temporary
            electrical connections on a breadboard. Jumper wires allow you to
            connect components, rows, and power rails without soldering. They
            enable rapid changes and experimentation, which is essential during
          ...
          />
          <p>
            Resistors are non-polarized components, meaning their orientation
            does not matter.
          </p>
          ...
          <h3>Why They Matter</h3>
          <p>
            LEDs provide immediate visual feedback and are often used to
            indicate power, signal states, or activity.
          </p>
          ...
          <h3>Common Mistake</h3>
          <p>
            Failing to use a resistor on the base pin can allow excessive
            current to flow, which may permanently damage the transistor.
          </p>
          ...
          <p>
            ...
            suppressing voltage spikes generated by inductive loads such as
            motors and relays.
          </p>
          ...
          <h3>Key Property</h3>
          <p>
            They are <strong>polarized</strong>. Therefore, reversing polarity
          ...
          <h3>What It Is</h3>
          <p>
            The 74HC595 is an 8-bit serial-to-parallel shift register. It is
            used to expand microcontroller outputs, allowing control of many
            devices (like LEDs) with few pins by converting serial data to
            parallel.
          </p>
          ...
          <h3>Why It Matters</h3>
          <p>
            Optocouplers improve safety and reduce electrical noise by
            preventing direct electrical connections between sensitive and
            high-power sections of a circuit.
          </p>
          <img
