...
export function ShopCart() {
  ...
  const order = async () => {
    ...
    try {
      ...
      setMessage(
        `Order #${result.orderId} placed for ${result.totalCost} credits.${
  ...
  return (
    <>
      <button
        ...
        className="fixed right-4 bottom-4 z-50 flex items-center gap-3 rounded-full border-[1.5px] border-black bg-black px-5 py-3 font-bold text-white shadow-[5px_5px_0_#BD0F32] transition hover:-translate-y-0.5 hover:bg-[#BD0F32] hover:shadow-[5px_5px_0_#000]"
      >
        <span>Cart</span>
        <span className="rounded-full bg-white px-2 py-0.5 text-xs text-black">
          {count} item{count === 1 ? "" : "s"}
        </span>
        {total > 0 ? <span>{total}c</span> : null}
      </button>
      ...
      {open ? (
        <div className="fixed inset-0 z-50 bg-black/45 backdrop-blur-sm">
          ...
          />
          <div className="absolute right-0 top-0 flex h-full w-full max-w-xl flex-col border-l-[1.5px] border-black bg-[#fefffe] shadow-[-12px_0_0_rgba(0,0,0,0.22)]">
            <div className="border-b-[1.5px] border-black bg-white p-6">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {placedOrder ? (
                <div className="rounded-[18px] border-[1.5px] border-black bg-white p-6 text-center shadow-[4px_4px_0_#000]">
                  ...
                  <div className="mt-6 rounded-[14px] border border-black bg-[#f4f4f4] p-4">
                    <p className="text-sm font-bold text-black/55">Total</p>
                    <p className="text-3xl font-black text-black">
                      {placedOrder.totalCost} credits
                    </p>
                    {placedOrder.merged ? (
                  ...
                  <button
                    ...
                    className="mt-6 w-full rounded-full border border-black bg-[#BD0F32] px-5 py-3 text-sm font-black text-white transition hover:bg-black"
                  >
                    Done
                  </button>
                </div>
                ...
                items.length === 0 ? (
                  <div className="rounded-[18px] border-[1.5px] border-dashed border-black bg-white p-8 text-center">
                  ...
                  <div className="space-y-4">
                    {items.map((item) => (
                      <div
                        key={item.productId}
                        className="rounded-[18px] border-[1.5px] border-black bg-white p-4 shadow-[4px_4px_0_#000]"
                      >
                        <div className="grid grid-cols-[72px_1fr_auto] gap-4">
                          ...
                          <p className="text-lg font-black text-[#BD0F32]">
            ...
            <div className="border-t-[1.5px] border-black bg-white p-6">
              <div className="mb-4 flex items-center justify-between text-sm">
                ...
                <span className="text-3xl font-black text-black">{total}c</span>
              </div>
