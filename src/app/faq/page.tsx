  ...
  return (
    <DocsFrame>
      <section>
        ...
        <ProseCard>
          <p>
            Welcome to the FAQ! This page attempts to point you to the right
            place when you have a question. It&apos;ll be constantly updated
            throughout the event as more questions get asked! As always, if
            anything is unclear, ask in #breadboard for help!
          </p>
          ...
          <p>
            ...
            <strong>Not just a schematic</strong>, but a working prototype with
            a purpose, a polished enclosure, and a build log to show how you got
          ...
          <p>
            ...
            valid project looks like, links to a sample project so you can see
            the general direction, and includes tutorials and component
            references to help you along the way. Projects are submitted via
            GitHub, and our Hack Club Slack channel is where you can ask
            questions, share progress, and get feedback.
          </p>
          ...
          <blockquote>
            <p>
              Note: Although at first glance the Arduino kit has more, do
              research to see what you need! For instance, ESP32s are more
              compact, and have WiFi and Bluetooth capabilities.
            </p>
          </blockquote>

          <p>
            After your first ship, there will be a shop where you can submit
            more projects and redeem additional kits and components.
          </p>

          <h2>Who runs this?</h2>
          <p>
            This is organized by Hack Club, a 501(c)(3) nonprofit that supports
            a global community of 105,892 and counting high school makers.
          </p>
        </ProseCard>
      </section>
    </DocsFrame>
