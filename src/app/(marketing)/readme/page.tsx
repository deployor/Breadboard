  ...
  return (
    <section>
      ...
      <ProseCard>
        ...
        <ul>
          <li>
            After the initial submission, there will be a shop. Rewards will be
            time and quality based, similar to Blueprint's build submission
            ...
            <a href="https://github.com/hackclub/lookout">Lookout</a> to verify
            them.
          </li>
          <li>
