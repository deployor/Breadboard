    ...
    <section>
      <PageHero title="Example submission">
        <p className="mt-4 max-w-3xl text-lg leading-relaxed text-black/80">
          This submission is still in development, is currently in progress, and
          is not the final submission.
        </p>
      </PageHero>
      ...
      <ProseCard>
        ...
        <p>
          ...
          for making something real and interactive rather than just a basic LED
          circuit. The kit gives me enough components to actually replicate the
          core Tamagotchi experience: a display, input buttons, a buzzer, and
          some sensors for ambient awareness.
        </p>
        ...
        <p>
          Then disaster struck. <strong>I lost all my progress</strong> after a
          KiCad crash and had to restart the symbol from scratch.
        </p>
        ...
        <p>
          ...
          <strong>external pull-up resistors</strong> on the I2C lines (SDA and
          SCL).
        </p>

        <p>
          My available resistor values were 220 ohm, 1k, and 10k. The
          recommended value for I2C pull-ups is typically around 4.7k, so 1k is
          the closest I have and will work fine.
        </p>
        ...
        <blockquote>
          ...
          reliable signaling, so external pull-ups are definitely the right call
          here.
        </blockquote>
        ...
        <p>
          ...
          <strong>active-low</strong> layout, which is the most common approach:
        </p>
        <ul>
          <li>
        ...
        <details>
          ...
          <p>
            Active-low means the button is "active" (pressed) when the signal is
            LOW (0V / GND). The internal pull-up resistor holds the pin HIGH
            when idle. This is clean and simple, no extra resistors needed, just
        ...
        <p>
          ...
          spacing would be an issue, and it surfaced the interesting question of
          whether an ESP32 even <em>fits</em> on a standard breadboard. After
          testing, a bent wire bridges the ESP32 across the gap perfectly and
          still makes contact on both rails.
        </p>
        ...
        <p>
          ...
          perfect for this. Finding usable documentation took surprisingly long.
        ...
        <p>
          ...
          , which I had to discover through trial and error. This caused errors
          that nuked my schematic progress again.
        </p>

        <p>
          My workaround: instead of creating a new schematic from scratch (which
          kept breaking), I imported a working schematic as a base and built
          from there.
        </p>
