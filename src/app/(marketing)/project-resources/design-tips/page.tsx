      ...
      <ProseCard>
        ...
        <ul>
          ...
          <li>
            ...
            idea of which one would physically look the best, which narrows down
            your choices
          </li>
          <li>
            Use variables in Fusion! They allow you to calculate measurements as
            functions of other ones which saves you a lot of time on iteration
          </li>
        </ul>
        ...
        <p>
          ...
          your project on the computer to make sure that you can actually build
          them in real life! Here are some of them:
        </p>
        ...
        <ul>
          <li>
            ...
            your printer, the filament, etc. Your parts WILL NOT fit otherwise.
          </li>
          <li>
            You can print out your PCBs on paper and see how large they&apos;ll
            be before actually ordering to get a good gauge for size.
          </li>
          <li>
