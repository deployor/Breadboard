...
export function AddProductForm() {
  ...
  if (!open) {
    return (
      <button
        ...
        className="rounded-full border border-black bg-[#BD0F32] px-5 py-3 text-sm font-black text-white shadow-[4px_4px_0_#000] transition hover:-translate-y-0.5 hover:bg-black"
      >
        Add product
      </button>
    );
  ...
  return (
    <div className="rounded-[20px] border-[1.5px] border-black bg-[#fffaf1] p-6 shadow-[5px_5px_0_#000]">
      ...
      <button
        ...
        onClick={submit}
        disabled={saving}
        className="mt-5 rounded-full border border-black bg-[#BD0F32] px-5 py-3 text-sm font-black text-white transition hover:bg-black disabled:opacity-50"
      >
...
export function ProductAdminCard({
  ...
  return (
    <div className="rounded-[20px] border-[1.5px] border-black bg-white p-5 shadow-[5px_5px_0_#000]">
      {editing ? (
        <div>
          <ProductFields value={form} onChange={setForm} />
        ...
        <div className="grid gap-4 lg:grid-cols-[112px_1fr_auto] lg:items-center">
          ...
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="rounded-full border border-black bg-[#fffaf1] px-3 py-1 text-xs font-black text-black">
          ...
          <div className="flex flex-wrap gap-2 lg:justify-end">
            ...
            <button
              ...
              onClick={toggle}
              disabled={saving}
              className="rounded-full border border-black px-4 py-2 text-sm font-bold transition hover:bg-black hover:text-white disabled:opacity-50"
            >
            ...
            <button
              ...
              onClick={remove}
              disabled={saving}
              className="rounded-full border border-red-700 bg-red-50 px-4 py-2 text-sm font-bold text-red-700 transition hover:bg-red-700 hover:text-white disabled:opacity-50"
            >
              Delete
            </button>
          </div>
