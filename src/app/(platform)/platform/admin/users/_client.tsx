      ...
      <div className="overflow-hidden rounded-[14px] border border-black bg-white shadow-[5px_5px_0_#000]">
        <div className="flex items-center justify-between gap-4 border-b border-black bg-[#f4f4f4] px-5 py-4">
          <div>
            ...
            <h2 className="text-2xl font-black text-black">Users table</h2>
          </div>
          <input
            type="search"
            value={query}
          ...
          <thead className="bg-black text-white">
            <tr>
              ...
              <SortableHeader
                ...
                onSort={setSortKey}
              />
              <th className="px-4 py-3 font-black uppercase tracking-[0.12em]">
                Admin
              </th>
              ...
              >
                ...
                <td className="px-4 py-3">
                  <button
                    ...
                    className="rounded-full border border-black bg-[#BD0F32] px-3 py-1.5 text-xs font-black text-white shadow-[2px_2px_0_#000] transition hover:bg-black"
                  >
                    Manage
                  </button>
                </td>
