    ...
    <DocsFrame>
      <section>
        ...
        <ProseCard>
          ...
          <p>
            Both are required. You don't get to skip the build submission.
            ...
            <ul className="space-y-3 text-sm text-black">
              <li className="flex items-start gap-3">
                ...
                <span>
                  ...
                  Not a bare breadboard sitting loose. Your circuit needs to
                  live inside a real, designed case with proper mounting.
                  Screws, clips, or press fits. Something you'd actually hand to
                  someone.
                </span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>
                  ...
                  Even if it's untested, it needs to exist and be in your repo.
                  A microcontroller with no code is just a paperweight.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full border-[1.1px] border-black bg-black text-xs text-white">
                ...
                <span>
                  <strong>A working physical build with a demo.</strong> You
                  built it, you proved it works. A video showing it doing its
                  thing is required at the build stage!
                </span>
              </li>
            </ul>
          </div>
          ...
          <ul>
            ...
            <li>
              Have firmware. Even untested is fine, but it needs to exist.
            </li>
            <li>
            ...
            <li>
              Have been looked over by someone else before you submit. Fresh
              eyes catch things yours won't.
            </li>
          </ul>
          ...
          <p>
            Once you receive your kit and build your project, you are required
            to submit your build. This is not optional. Receiving the kit and
            going silent is not okay.
          </p>
          ...
          <ul>
            ...
            <li>
              A build log covering what you made, the decisions you made along
              the way, and what went wrong
            </li>
          </ul>
